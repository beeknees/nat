define(function(require, exports, module) { // jshint ignore:line
    ...
    describe('DemoView', function() {
        ...
        beforeEach(function() {
            ...
            spyOn(DemoView.prototype, 'wait').andReturn(promise);
        ...
        describe('#init', function() {
            ...
            //     spyOn(DemoView.prototype, 'init').andCallThrough();
            //     spyOn(DemoView.prototype, 'setupHandlers').andCallThrough();
            //     spyOn(DemoView.prototype, 'createChildren').andCallThrough();
            //     spyOn(DemoView.prototype, 'layout').andCallThrough();
        ...
        describe('#destroy', function() {
            beforeEach(function() {
                ...
                spyOn(demoView, 'disable').andCallThrough();
        ...
        describe('#wait', function() {
            var tempSetTimeout;
            beforeEach(function() {
                DemoView.prototype.wait.andCallThrough();
